		  ...
		  If str_Cuotas = 12 Then
		   ...
		   End If
	 		If str_Cuotas = 6 Then
	             ...
	             Call Carga()
			     wait 1
			     If JavaWindow("Ejecutivo de interacción").JavaDialog("JDialog").JavaStaticText("El Plan de Financiamiento").Exist = True Then
			     	wait 1
			     	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() & "Financiamiento6cuotas.png", True
		         	imagenToWord "Mensaje: Financiamiento de 6 cuotas",RutaEvidencias() & "Financiamiento6cuotas.png"
